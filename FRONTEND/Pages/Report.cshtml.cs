...
public class ReportModel : PageModel
{
    ...
    public ReportModel(IPadepokanManage manageEngineApi, IJsonOptions jOpt)
    {
    ...
    {
        AllDdl = await _manageEngineApi.Ready().DropdownUserAndMasterRepportAsync();
    }

    public async Task<IActionResult> OnGetReadAsync(DataSourceLoadOptionsBase set)
    {
        var response = await _manageEngineApi.Ready().ReportAllAsync();
